...
// Check that API key is set; warn if missing in deployment
if (!process.env.GEMINI_API_KEY) {
    console.warn('⚠️ WARNING: GEMINI_API_KEY is not set in environment variables! AI endpoints will fail.');
}
